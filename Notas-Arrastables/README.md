...
<img src="./assets/principal.png" alt="Imagen principal" width="60%">

### Funcionamiento de arrastre y eliminacion de la nota
<img src="./assets/arrastrar.gif" alt="Funcionamiento de arrastre" width="40%"> <img src="./assets/eliminar.gif" alt="eliminar" width="37.5%">
